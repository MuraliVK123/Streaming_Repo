  ...
  DataSource.prototype.query = function (options) {
    ...
    var observables = options.targets.map(function (target) {
      ...
      return new rxjs__WEBPACK_IMPORTED_MODULE_4__["Observable"](function (subscriber) {
        query.timeoutS = parseFloat(Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_3__["getTemplateSrv"])().replace(query.timeoutS.toString(), options.scopedVars));
        query.server = Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_3__["getTemplateSrv"])().replace(query.server, options.scopedVars);
        query.capacity = parseFloat(Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_3__["getTemplateSrv"])().replace(query.capacity.toString(), options.scopedVars));
        ...
        var server = query.server || _this.serverURL;
        ...
        connection.onerror = function (error) {
          ...
          clearInterval(interval); //throw new Error("Can't connect to " + this.serverURL);
        };
    ...
    console.log.apply(console, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"])(observables));
    return rxjs__WEBPACK_IMPORTED_MODULE_4__["merge"].apply(void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"])(observables));
  };
...
function (_super) {
  ...
  function QueryEditor() {
    ...
    _this.onCapacityChange = function (event) {
      var _a = _this.props,
          onChange = _a.onChange,
          query = _a.query,
          onRunQuery = _a.onRunQuery;
...
var defaultQuery = {
  capacity: 1000,
  timeoutS: 30 //server: "ws://test:8080",
