...
var DataSource = /*#__PURE__*/function (_DataSourceApi) {
  ...
  _createClass(DataSource, [{
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__.Observable(function (subscriber) {
          ...
          connection.onmessage = function (event) {
            ...
            if (query.type === "Live") {
              ...
              var _frameData = finalData[0];
              signalArray.push(query.target);
              var logData = {};
              finalData.map(function (test) {
              ...
              var _count = 0;
              var frame = {};
              frame["frame" + _count] = new _grafana_data__WEBPACK_IMPORTED_MODULE_1__.CircularDataFrame({
                append: 'tail'
              });
              if (frame["frame" + _count].fields.length <= 1) {
                //first time initalize the keys from the json data
                Object.keys(_frameData).forEach(function (k) {
                  if (k === "timestamp") {
                    frame["frame" + _count].addField({
                      name: k,
                      type: _grafana_data__WEBPACK_IMPORTED_MODULE_1__.FieldType.time,
                      values: logData[k]
                    });
                    ...
                    frame["frame" + _count].addField({
                      name: k,
                      type: Number(_frameData[k]) >= 0 ? _grafana_data__WEBPACK_IMPORTED_MODULE_1__.FieldType.number : _grafana_data__WEBPACK_IMPORTED_MODULE_1__.FieldType.string,
                      values: logData[k]
                    });
                  }
                });
              ...
              subscriber.next({
                data: [frame["frame" + _count]],
                key: query.refId + _count,
                state: _grafana_data__WEBPACK_IMPORTED_MODULE_1__.LoadingState.Streaming
              });
              _count = _count + 1;
    ...
    key: "processData",
    value: function () {
      var _processData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(options) {
        var _this3 = this;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              options.targets.map( /*#__PURE__*/function () {
                  ...
                  return _regeneratorRuntime().wrap(function _callee$(_context) {
                    while (1) switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        query.pattern = (0,_grafana_runtime__WEBPACK_IMPORTED_MODULE_2__.getTemplateSrv)().replace(query.pattern, options.scopedVars);
                        _context.next = 5;
                        return fetch(_this3.BaseURL + query.type + "/signals?pattern=" + query.pattern).then(function (response) {
...
var QueryEditor = /*#__PURE__*/function (_PureComponent) {
  ...
  function QueryEditor(instanceSettings) {
    ...
    _this.BaseURL = _this.serverURL.replace("host", window.location.origin);
    var _query = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()(_this.props.query, types__WEBPACK_IMPORTED_MODULE_3__.defaultQuery);
  ...
  _createClass(QueryEditor, [{
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return fetch(this.BaseURL + type + "/signals?pattern=*").then(function (response) {
                ...
                signalData = lodash__WEBPACK_IMPORTED_MODULE_4___default().map(slicesData, function (v, i) {
                  return {
                    label: v,
                    value: v
                  };
    ...
    key: "render",
    value: function render() {
      var query = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()(this.props.query, types__WEBPACK_IMPORTED_MODULE_3__.defaultQuery);
      console.log("signals:" + signalData);
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        ...
        className: "gf-form-label query-keyword width-10"
      }, "Display Names")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        className: "css-1so7yeh width-4",
        ...
        className: "gf-form-label query-keyword width-10"
      }, "Alias")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", {
        className: "gf-form-input",
        value: alias,
        ...
        className: "gf-form-label query-keyword width-10"
      }, "Scale")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", {
        className: "gf-form-input",
        value: scale,
        ...
        className: "gf-form-label query-keyword width-10"
      }, "Pattern")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", {
        className: "gf-form-input",
        value: pattern,
        style: patternStyle,
